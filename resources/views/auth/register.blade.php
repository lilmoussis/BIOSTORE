                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="nom" name="nom" required autofocus placeholder="Nom">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="prenom" name="prenom" required
                                        placeholder="Prenom">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="password" name="password" required placeholder="Mot de passe">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <button type="submit" style="background-color: #006735" class="btn btn-success btn-user btn-block">
                                    {{__('Valider')}}
                                </button>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small text-warning" href="{{ route('login') }}">Vous avez déjà un compte? S'identifier!</a>
                            </div>
                        </div>
                    </div>
                </div>
